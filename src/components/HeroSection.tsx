...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-start pt-32 lg:pt-32 overflow-visible">
      ...
      <div className="container relative z-10 mx-auto px-6 lg:px-12 pt-8 lg:pt-12">
